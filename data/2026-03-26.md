...
### [6] [Efficient Benchmarking of AI Agents](https://arxiv.org/abs/2603.23749)
*Franck Ndzomga*
...
### [11] [The DeepXube Software Package for Solving Pathfinding Problems with Learned Heuristic Functions and Search](https://arxiv.org/abs/2603.23873)
*Forest Agostinelli*
...
### [12] [DUPLEX: Agentic Dual-System Planning via LLM-Driven Information Extraction](https://arxiv.org/abs/2603.23909)
...
### [13] [AnalogAgent: Self-Improving Analog Circuit Design Automation with LLM Agents](https://arxiv.org/abs/2603.23910)
...
### [14] [From Pixels to Digital Agents: An Empirical Study on the Taxonomy and Technological Trends of Reinforcement Learning Environments](https://arxiv.org/abs/2603.23964)
...
### [15] [Language-Grounded Multi-Agent Planning for Personalized and Fair Participatory Urban Sensing](https://arxiv.org/abs/2603.24014)
*Xusen Guo,Mingxing Peng,Hongliang Lu,Hai Yang,Jun Ma,Yuxuan Liang*

Main category: cs.AI

TL;DR: MAPUS是一个基于大语言模型的多智能体框架，通过个性化与公平感知优化参与式城市传感。


<details>
  <summary>Details</summary>
Motivation: 现有参与式城市传感方法依赖集中式优化并假设参与者同质，导致僵化任务分配，忽视个人偏好与城市环境异质性。

Method: MAPUS将参与者建模为具有个人配置和日程的自主智能体，协调智能体执行公平感知选择，并通过语言协商动态细化 sensing 路线。

Result: 在真实数据集实验中，MAPUS在保持竞争性感知覆盖的同时，显著提升参与者满意度和公平性指标。

Conclusion: 该框架推动了以人为本、可持续的城市感知系统发展。
...
### [16] [ELITE: Experiential Learning and Intent-Aware Transfer for Self-improving Embodied Agents](https://arxiv.org/abs/2603.24018)
*Bingqing Wei,Zhongyu Xia,Dingai Liu,Xiaoyu Zhou,Zhiwei Lin,Yongtao Wang*

Main category: cs.AI

TL;DR: ELITE是一个具身智能体框架，通过经验学习和意图感知迁移，从交互经验中构建和检索策略，弥合视觉-语言模型的语义理解与可靠动作执行之间的差距，在基准测试中取得显著提升。


<details>
  <summary>Details</summary>
Motivation: 视觉-语言模型（VLMs）从静态数据中学习丰富的语义知识，但缺乏与物理世界交互的能力，导致具身智能体在复杂任务中失败（如跳过关键步骤、执行无效动作、重复错误）。根本问题在于静态训练数据与具身任务的动态物理交互之间存在鸿沟。

Method: ELITE采用两种协同机制：1) 自反思知识构建：从执行轨迹中提取可复用策略，并通过结构化精炼操作维护不断演进的策略池；2) 意图感知检索：从策略池中识别与当前任务意图相关的策略并迁移应用，实现持续学习和知识转移。

Result: 在EB-ALFRED和EB-Habitat基准测试中，ELITE在无监督在线设置中分别超越基础VLMs 9%和5%。在监督设置中，对未见任务类别的泛化能力优于现有基于训练的最先进方法，证明了其有效性。

Conclusion: ELITE通过让智能体从自身交互经验中持续学习并迁移知识，有效弥合了语义理解与可靠动作执行之间的差距，为构建高性能具身智能体提供了新范式。
...
### [17] [Enhanced Mycelium of Thought (EMoT): A Bio-Inspired Hierarchical Reasoning Architecture with Strategic Dormancy and Mnemonic Encoding](https://arxiv.org/abs/2603.24065)
*Florian Odi Stummer*
...
### [18] [AI-Supervisor: Autonomous AI Research Supervision via a Persistent Research World Model](https://arxiv.org/abs/2603.24402)
*Yunbo Long*
...
### [19] [From Liar Paradox to Incongruent Sets: A Normal Form for Self-Reference](https://arxiv.org/abs/2603.24527)
...
### [20] [Completeness of Unbounded Best-First Minimax and Descent Minimax](https://arxiv.org/abs/2603.24572)
*Quentin Cohen-Solal*

Main category: cs.AI

TL;DR: 本文证明完成技术增强的广义Unbounded Best-First Minimax和Descent Minimax算法总能计算双人完美信息游戏中的最佳策略，并通过实验验证其性能提升。


<details>
  <summary>Details</summary>
Motivation: 现有核心算法（如Unbounded Best-First Minimax和Descent Minimax）即使在无限搜索时间内也无法总是确定获胜策略，虽引入完成技术改进，但其能否确保总是找到获胜策略长期未解。

Method: 将两种算法与完成技术结合进行一般化，定义一类算法，并采用理论证明展示该类算法能计算最佳策略；同时设计实验比较完成技术的实际效果。

Result: 理论上：证明完成技术增强的广义算法总能输出最佳策略。实验上：完成技术显著提高算法的获胜性能。

Conclusion: 完成技术足以确保此类搜索算法在双人完美信息游戏中始终确定最佳策略，且实践中有效提升表现。
...
### [21] [The Stochastic Gap: A Markovian Framework for Pre-Deployment Reliability and Oversight-Cost Auditing in Agentic Artificial Intelligence](https://arxiv.org/abs/2603.24582)
